    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="flashdata-programStudi" data-flashdata="<?= $this->session->flashdata('flash'); ?>">
                </div>
                <?php if ($this->session->flashdata('flash')): ?>
                    <!-- <div class="alert alert-success alert-dismissible fade show" role="alert"> Program Studi
                        ...
                        <?php foreach ($ProgramStudi as $row): ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-end">
                                    ...
                                    <a type="button" class="btn btn-danger btn-sm ml-1 tombol-delete-programStudi"
                                        class="badge badge-danger rounded-circle"
                                        href="<?= base_url(); ?>ProgramStudi/delete/<?= $row['id']; ?>">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-secondary">
                <form action="<?= base_url(); ?>ProgramStudi/add" method="post">
