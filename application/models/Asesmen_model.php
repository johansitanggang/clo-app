...
class Asesmen_model extends CI_Model
{
    ...
    public function addNilaiMahasiswa()
    {
        ...
        $q1 = (int) $this->input->post("q1", true);
        $q2 = (int) $this->input->post("q2", true);
        $p1 = (int) $this->input->post("p1", true);
        $p2 = (int) $this->input->post("p2", true);
        $p3 = (int) $this->input->post("p3", true);
        $p4 = (int) $this->input->post("p4", true);
        $p5 = (int) $this->input->post("p5", true);
        $a1 = (int) $this->input->post("a1", true);
        $a2 = (int) $this->input->post("a2", true);
        $a3 = (int) $this->input->post("a3", true);
        $a4 = (int) $this->input->post("a4", true);
        $a5 = (int) $this->input->post("a5", true);
        $mse = (int) $this->input->post("mse", true);
        $fse = (int) $this->input->post("fse", true);
        $pp1 = (int) $this->input->post("pp1", true);
        $pp2 = (int) $this->input->post("pp2", true);
